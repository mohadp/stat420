...
Also, we tried to train a model involving polynomials, but there was no polynomial term that was significant enough when performing model building explorations.
