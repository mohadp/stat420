...
Though, `interaction_model`, `model_transformation_boxcox` were successful at explaining  $`r 100*comp["r2", "model_transformation_boxcox"]` < R^2 `r 100*comp["r2", "interaction_model"]`$% of the `aquisition_amount_price` variability.
